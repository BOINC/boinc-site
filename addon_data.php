...
array('https://github.com/ivanprea/BOINC---Monitor-Dashboard',
    'BOINC Dashboard',
    '',
    'Web dashboard for monitoring a client running on the local machine',
    'https://github.com/ivanprea/BOINC---Monitor-Dashboard',
    '',
    'A lightweight, self-hosted web dashboard for monitoring a BOINC client running on a local machine (originally built for a Debian LXC container), without needing to open BOINC Manager and reconnect every time.',
    1787448563
),
