...
<p>We would also like to cover the cases where people use two or more email addresses with valid and invalid passwords across multiple projects and properly handle attaching to World Community Grid in combination with other BOINC projects.</p>
